...
public class GameMessages {
    ...
    public static final String NAME_ALREADY_TAKEN = "Enter a different name as the provided one is already taken";
    public static final String HELP_STRING = "This program simulates the 7-11-Doubles drinking game.\n" +
            "\n" +
    ...
    public static final String PAUSE_TIME = "Pause time between rolls is ";
    public static final String MAX_DRINK_MESSAGE = "Maximum number of drinks is ";
    public static final String MORE_PLAYERS_NEEDED = "At least 2 players required to start game";
}